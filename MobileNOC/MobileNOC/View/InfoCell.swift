...
class InfoCell: DatasourceCell {
  ...
  override var datasourceItem: Any? {
    didSet {
      guard let userData = datasourceItem as? UserData else { return }
      nameLabel.text = userData.name
      nameLabel2.text = userData.name2
      ipAddressLabel.text = userData.ipAddress
      deviceIPSubnetMaskLabel.text = userData.deviceIPSubnetMask
    }
  }
